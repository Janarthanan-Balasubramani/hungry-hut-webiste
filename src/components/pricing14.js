        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text188 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing14-text198 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text177 thq-body-large">
                          or $499 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span>
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing14-text207 thq-body-large">
                          Business plan
                        </span>
                      </Fragment>
                    )}
